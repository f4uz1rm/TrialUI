        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown nav-profile">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="https://avatars.githubusercontent.com/u/62155382?v=4" alt="profile">
                </a>
                <div class="dropdown-menu" aria-labelledby="profileDropdown">
                    <div class="dropdown-header d-flex flex-column align-items-center">
                        <div class="figure mb-3">
                            <img src="https://avatars.githubusercontent.com/u/62155382?v=4" alt="">
                        </div>
                        <div class="info text-center">
                            <p class="name font-weight-bold mb-0">Fauzi Rizky Mauladani</p>
                            <p class="email text-muted mb-3">f4uz1rm@gmail.com</p>
                        </div>
                    </div>
                    <div class="dropdown-body">
